package com.example.hellonavigation.nestednavtypes
                ...
                Scaffold{ paddingValues ->
                    Column(
                        ...
                        NavHost(
                            ...
                            startDestination = Product(material = Material(description = "Steel"))
                        ) {
                            composable<Product> {
                                val product : Product = it.toRoute()
                                Text("Product is made from ${product.material.description}")
                            }
                        }
                        Column(
